...
internal class MessageRequestAttributes (googleMeeting: GoogleMeeting, userAvailability: UserAvailability, meetingUserId: Long, conversationId: Long, timeSlot: Date) {
    ...
    internal var meetingUserId: Long = meetingUserId
