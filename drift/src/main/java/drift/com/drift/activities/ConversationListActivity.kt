...
class ConversationListActivity : DriftActivity() {
    ...
    internal var conversationRecyclerView: RecyclerView
    internal var progressBar: ProgressBar
    internal var networkAvailabilityBar: TextView

    internal var emptyState: LinearLayout
    internal var emptyStateButton: Button

    internal var conversationListAdapter: ConversationListAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        conversationRecyclerView.addOnItemTouchListener(RecyclerTouchListener(this, conversationRecyclerView, ClickListener { view, position ->
    ...
    override fun refreshData() {
        ...
        if (auth != null && auth!!.endUser != null) {
            ...
            UserManager.instance.getUsers(auth!!.endUser!!.orgId!!, UserManagerCallback { success ->
                if (success!!) {
                    fetchData(auth!!)
                } else {
    ...
    private fun fetchData(auth: Auth) {
        ConversationManager.instance.getConversationsForEndUser(auth.endUser!!.id, APICallbackWrapper<ArrayList<ConversationExtra>> { response ->
            if (response != null) {
                progressBar.visibility = View.GONE
