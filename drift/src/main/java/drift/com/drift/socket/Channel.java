...
public class Channel {
    ...
    public Channel(final String topic, final JsonElement payload, final Socket socket) {
        this.topic = topic;
     ...
     */
    private Push push(final String event, final JsonElement payload, final long timeout)
    ...
    public Push push(final String event, final JsonElement payload) throws IOException {
        ...
        final TimerTask rejoinTimerTask = new TimerTask() {
            ...
            public void run() {
                try {
                    ...
                    LoggerHelper.logMessage(TAG, "Failed to rejoin");
                }
            }
        };
